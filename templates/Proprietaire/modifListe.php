...
<h1 class="text-center">Modification d'un proprietaire</h1>
<form action="/proprietaire/modifForm" method='post'>
    <div class=" row mb-3">
        ...
        ?>
            <label for="lesProprietaires" class="col-lg-4 col-form-label">Choisissez le propriétaire à modifier</label>
            <div class="col-sm-12">
                <!-- liste déroulante -->
