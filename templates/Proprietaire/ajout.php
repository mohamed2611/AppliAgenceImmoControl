...
<form action="/proprietaire/ajoutTrait" method='post'>
    ...
    <div class="row mb-3">
        <label for="laVille" class="col-lg-4 col-form-label">Ville</label>
        <div class="col-sm-12">
            <!-- liste déroulante -->
            <select class="form-select form-select-md" name="lstVille">
                <?php foreach ($lesVilles as $uneVille) {
                    ...
                    if (isset($leProprio) && $leProprio->GetGestionProprio()->GetInsee() == $insee)
    ...
    <div class="row mb-3">
        <label for="leModeGestion" class="col-lg-4 col-form-label">Mode de Gestion</label>
        <div class="col-sm-12">
            <!-- liste déroulante -->
            <select class="form-select form-select-md" name="lstGestionProprio">
