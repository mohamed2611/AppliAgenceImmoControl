<h1 class="text-center">Modifier un locataire    </h1>
...
<div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-12">
            <input type="text" class="form-control" name="salaireMensuel" value="<?php if (isset($leLocataire))  echo $leLocataire->getSalaireMens();  ?>" id="salaireMensuel">
        </div>
    </div>
    <div class="row mb-3">
    ...
    <input type="hidden" name="idLocataire" value="<?php if ($leLocataire != null) echo $leLocataire->getId(); ?>" <div class="row mb-3">
